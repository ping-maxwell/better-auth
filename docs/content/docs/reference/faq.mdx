...
<Accordion title="How to seed a user">
  You can seed an initial user by using the `auth.api.signInEmail` method on a custom seed script that you can then call.
